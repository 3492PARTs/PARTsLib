...
public class PARTsPreferences {
     ...
     * {@link org.parts3492.partslib.network.PARTsNT PARTsNT}, the value is not cached, meaning it
     * is fetched every time it is accessed.
     */
     ...
     *
     * @param name The name of the preference to get.
     * @param defaultValue The value to return if the preference does not exist or is not an
     *     Integer.
     * @return The value of the preference or the default value.
     */
